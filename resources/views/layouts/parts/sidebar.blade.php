              ...
              <ul class="navbar-nav pt-lg-3">
                  <li class="nav-item">
                      <a class="nav-link" href="./">
                          ...
                          <span class="nav-link-title"> Menu Item </span>
                      </a>
                  </li>
                  <li class="nav-item active dropdown">
                      <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                          ...
                          <span class="nav-link-title"> Menu Submenu </span>
                      </a>
                      <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                              <div class="dropdown-menu-column">
                                  ...
                                  <a class="dropdown-item" href="./alerts.html"> Sub Menu 2 </a>
                                  <div class="dropend">
                                      ...
                                      <div class="dropdown-menu">
                                          <a href="./sign-in.html" class="dropdown-item"> Sub Sub1 </a>
                                          <a href="./sign-in-link.html" class="dropdown-item"> Sub Sub2 </a>
                                      </div>
                                  </div>
